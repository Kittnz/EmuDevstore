...
<ul class="breadCrumbs">
	<li><a href="index.php?page=Index<?php echo SID_ARG_2ND; ?>"><img src="<?php echo StyleManager::getStyle()->getIconPath('indexS.png'); ?>" alt="" /> <span><?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_lang4c57c498f4c482207acf6e7c9dfcc06c9a116115 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang4c57c498f4c482207acf6e7c9dfcc06c9a116115, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></span></a> &raquo;</li>
	<li><?php if (MODULE_MEMBERS_LIST) { ?><a href="index.php?page=MembersList<?php echo SID_ARG_2ND; ?>"><img src="<?php echo StyleManager::getStyle()->getIconPath('membersS.png'); ?>" alt="" /> <span>Members</span></a><?php } else { ?><img src="<?php echo StyleManager::getStyle()->getIconPath('membersS.png'); ?>" alt="" /> <span>Members</span><?php } ?> &raquo;</li>
</ul>

<?php $this->assign('adminOptions', ''); ?>
<?php if ($this->v['this']->user->getPermission('admin.user.canEditUser')) { ?>
	<?php ob_start(); ?><li><a href="acp/index.php?form=Login&amp;url=index.php%3Fform=UserEdit%26userID%3D<?php echo $this->v['user']->userID; ?>%26packageID%3D<?php echo PACKAGE_ID; ?>">Edit user</a></li><?php
...
?>
	<?php if (MODULE_AVATAR == 1) { ?>
		<?php if ($this->v['user']->disableAvatar == 1) { ?>
			<?php ob_start(); ?><li><a href="index.php?action=UserAvatarEnable&amp;userID=<?php echo $this->v['userID']; ?>&amp;t=<?php echo SECURITY_TOKEN; ?><?php echo SID_ARG_2ND; ?>">Enable Avatar</a></li><?php
$this->v['tpl']['capture']['default'] = ob_get_contents();
ob_end_clean();
$this->append('adminOptions', $this->v['tpl']['capture']['default']);
?>
		<?php } else { ?>
			<?php ob_start(); ?><li><a href="index.php?action=UserAvatarDisable&amp;userID=<?php echo $this->v['userID']; ?>&amp;t=<?php echo SECURITY_TOKEN; ?><?php echo SID_ARG_2ND; ?>">Disable Avatar</a></li><?php
$this->v['tpl']['capture']['default'] = ob_get_contents();
ob_end_clean();
$this->append('adminOptions', $this->v['tpl']['capture']['default']);
?>
...
<div class="mainHeadline">
	...
	<div class="headlineContainer">
		<h2><a href="index.php?page=User&amp;userID=<?php echo $this->v['userID']; ?><?php echo SID_ARG_2ND; ?>">Profile of &quot;<?php echo StringUtil::encodeHTML($this->v['user']->username); ?>&quot;</a></h2>
		<?php if ($this->v['user']->getOldUsername()) { ?>
			<p>(formerly &quot;<?php echo StringUtil::encodeHTML($this->v['user']->getOldUsername()); ?>&quot;)</p>
		<?php } ?>
	</div>
	<?php if ($this->v['adminOptions'] != '') { ?>
					...
					<div class="userPersonals">
						<p class="userName">
							<?php if ($this->v['user']->isOnline()) { ?>
								<img src="<?php echo StyleManager::getStyle()->getIconPath('onlineS.png'); ?>" alt="" title="<?php $this->tagStack[] = array('lang', array('username' => StringUtil::encodeHTML($this->v['user']->username))); ob_start(); ?>wcf.user.online<?php $_lang78fefef054b12bcba1f9bdfb4678157825a190f7 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang78fefef054b12bcba1f9bdfb4678157825a190f7, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>" />
							<?php } else { ?>
								<img src="<?php echo StyleManager::getStyle()->getIconPath('offlineS.png'); ?>" alt="" title="<?php $this->tagStack[] = array('lang', array('username' => StringUtil::encodeHTML($this->v['user']->username))); ob_start(); ?>wcf.user.offline<?php $_lang93d5849082c096ba991a456b09307d3ffd1b2b80 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang93d5849082c096ba991a456b09307d3ffd1b2b80, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>" />		
							<?php } ?>
...
?>
							...
							<?php if ($this->v['this']->user->userID) { ?>
								<?php if ($this->v['user']->userID != $this->v['this']->user->userID) { ?>
									<?php if ($this->v['user']->blackUserID) { ?>
										<li><a href="index.php?form=BlackListEdit&amp;remove=<?php echo $this->v['user']->userID; ?>&amp;t=<?php echo SECURITY_TOKEN; ?><?php echo SID_ARG_2ND; ?>" title="Cancel ignoring"><img src="<?php echo StyleManager::getStyle()->getIconPath('removeM.png'); ?>" alt="" /> <span>Cancel ignoring</span></a></li>
									<?php } ?>
									
									<?php if ($this->v['user']->whiteUserID || $this->v['user']->invitedUserID) { ?>
										<li><a href="index.php?form=WhiteListEdit&amp;remove=<?php echo $this->v['user']->userID; ?>&amp;t=<?php echo SECURITY_TOKEN; ?><?php echo SID_ARG_2ND; ?>" title="Remove friend"><img src="<?php echo StyleManager::getStyle()->getIconPath('deleteM.png'); ?>" alt="" /> <span>Remove friend</span></a></li>
									<?php } else { ?>	
										<?php if ( ! $this->v['user']->blackUserID) { ?>
											<li><a href="index.php?form=BlackListEdit&amp;add=<?php echo $this->v['user']->userID; ?>&amp;t=<?php echo SECURITY_TOKEN; ?><?php echo SID_ARG_2ND; ?>" title="Ignore user"><img src="<?php echo StyleManager::getStyle()->getIconPath('removeM.png'); ?>" alt="" /> <span>Ignore user</span></a></li>
										<?php } ?>
										<li><a href="index.php?form=WhiteListEdit&amp;add=<?php echo $this->v['user']->userID; ?>&amp;t=<?php echo SECURITY_TOKEN; ?><?php echo SID_ARG_2ND; ?>" title="Add user to friend list"><img src="<?php echo StyleManager::getStyle()->getIconPath('addM.png'); ?>" alt="" /> <span>Add user to friend list</span></a></li>
									<?php } ?>
								<?php } else { ?>
									<li><a href="index.php?form=UserProfileEdit<?php echo SID_ARG_2ND; ?>" title="Edit my profile"><img src="<?php echo StyleManager::getStyle()->getIconPath('editM.png'); ?>" alt="" /> <span>Edit profile</span></a></li>
								<?php } ?>
							<?php } elseif ( ! REGISTER_DISABLED) { ?>
								<li><a href="index.php?page=Register<?php echo SID_ARG_2ND; ?>" title="Register now!"><img src="<?php echo StyleManager::getStyle()->getIconPath('registerM.png'); ?>" alt="" /> <span>Register now!</span></a></li>
							<?php } ?>
				...
				<?php if (count($this->v['connection']) > 0) { ?>
					<div class="friendsConnection">
						<h3 class="light">Your connection to &quot;<?php echo StringUtil::encodeHTML($this->v['user']->username); ?>&quot;</h3>
...
?> 
								<li class="dynItem<?php if ($this->v['tpl']['foreach']['connection']['first']) { ?> first<?php } elseif ($this->v['tpl']['foreach']['connection']['last']) { ?> last<?php } ?>">
									<div class="dynBox">
										<div class="dynBoxInner">
											<a href="index.php?page=User&amp;userID=<?php echo $this->v['friend']->userID; ?><?php echo SID_ARG_2ND; ?>" title="<?php $this->tagStack[] = array('lang', array('username' => StringUtil::encodeHTML($this->v['friend']->username))); ob_start(); ?>wcf.user.viewProfile<?php $_langf7e2d603a17a18bf4bc0e6a0f3475a4b859e15c4 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langf7e2d603a17a18bf4bc0e6a0f3475a4b859e15c4, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>">
				...
				<?php } elseif (count($this->v['network']) > 0) { ?>
					<div class="friendsNetwork">
						<h3 class="light">Your network</h3>
								...
								<li class="dynItem first">
									<div class="dynBox network1">
										<div class="dynBoxInner">
											...
											<span class="digitCaption">Direct Friends</span>
										</div>
									</div>
								</li>
							<?php } ?>
								...
								<li class="dynItem">
									<div class="dynBox network2">
										<div class="dynBoxInner">
											...
											<span class="digitCaption">Friends of friends</span>
										</div>
									</div>
								</li>
							<?php } ?>
								...
								<li class="dynItem">
									<div class="dynBox network3">
										<div class="dynBoxInner">
											...
											<span class="digitCaption">Third degree friends</span>
										</div>
									</div>
								</li>
							<?php } ?>
				...
				<?php } else { ?>
					<div class="friendsNone">
						<h3 class="light"><?php if ($this->v['this']->user->userID == $this->v['user']->userID) { ?>Extend your personal network by adding other members as friends.<?php } elseif ($this->v['this']->user->userID != 0) { ?>You have no connection to this user yet.<?php } else { ?>You have to register first, to connect to this user.<?php } ?></h3>
					</div>
				<?php } ?>
				<!--[if IE]>
...
?>
				<li<?php if (in_array($this->v['item']['menuItem'],$this->v['this']->getUserProfileMenu()->getActiveMenuItems())) { ?> class="activeTabMenu"<?php } ?>><a href="<?php echo StringUtil::encodeHTML($this->v['item']['menuItemLink']); ?>"><?php if ($this->v['item']['menuItemIcon']) { ?><img src="<?php echo StringUtil::encodeHTML($this->v['item']['menuItemIcon']); ?>" alt="" /> <?php } ?><span><?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo $this->v['item']['menuItem']; ?><?php $_lang8beb66bb374d3df7217719d888c6009d276e54c0 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang8beb66bb374d3df7217719d888c6009d276e54c0, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></span></a></li>
			<?php } } ?>
		</ul>
	</div>
...
?>
						<li<?php if (in_array($this->v['item']['menuItem'],$this->v['this']->getUserProfileMenu()->getActiveMenuItems())) { ?> class="activeSubTabMenu"<?php } ?>><a href="<?php echo StringUtil::encodeHTML($this->v['item']['menuItemLink']); ?>"><?php if ($this->v['item']['menuItemIcon']) { ?><img src="<?php echo StringUtil::encodeHTML($this->v['item']['menuItemIcon']); ?>" alt="" /> <?php } ?><span><?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo $this->v['item']['menuItem']; ?><?php $_lang64c4810acb750677f68e616738d5d0e6e867b4b0 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang64c4810acb750677f68e616738d5d0e6e867b4b0, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></span></a></li>
					<?php } } ?>
				</ul>
			<?php } else { ?>
				<div> </div>
