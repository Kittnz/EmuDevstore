...
?><?php
$outerTemplateNamedfa248cc51f979c95aadf5de5d9d74bd6a289429 = $this->v['tpl']['template'];
$this->includeTemplate("documentHeader", array(), (1 ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateNamedfa248cc51f979c95aadf5de5d9d74bd6a289429;
$this->v['tpl']['includedTemplates']["documentHeader"] = 1;
?>
<head>
	<title>Profil von &raquo;<?php echo StringUtil::encodeHTML($this->v['user']->username); ?>&laquo; - Mitglieder - <?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_lang59dd0239b0ad09e84518bbcd5190acd64e80d7c8 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang59dd0239b0ad09e84518bbcd5190acd64e80d7c8, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></title>
	<?php
$outerTemplateNamebbb24ead1d769d99f6357cb51b5e6c78aad62de7 = $this->v['tpl']['template'];
$this->includeTemplate('headInclude', array(), (false ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateNamebbb24ead1d769d99f6357cb51b5e6c78aad62de7;
...
<?php
$outerTemplateName9ef86474a97c63deb9771538e6a3f800828c9246 = $this->v['tpl']['template'];
$this->includeTemplate('header', array(), (false ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateName9ef86474a97c63deb9771538e6a3f800828c9246;
$this->v['tpl']['includedTemplates']['header'] = 1;
?>

<div id="main">
	<?php
$outerTemplateNamee1ebc739a9ee04cbffdde94ab7a461728a8ec96f = $this->v['tpl']['template'];
$this->includeTemplate("userProfileHeader", array(), (1 ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateNamee1ebc739a9ee04cbffdde94ab7a461728a8ec96f;
...
?>
							<div class="contentBox">
								<h3 class="subHeadline"><?php $this->tagStack[] = array('lang', array()); ob_start(); ?>wcf.user.option.category.<?php echo StringUtil::encodeHTML($this->v['category']['categoryName']); ?><?php $_lang1975f671f9f1cdd21acabaf8136f8372e6249c3b = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang1975f671f9f1cdd21acabaf8136f8372e6249c3b, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></h3>
...
?>
										...
										<?php } else { ?>
											<li class="<?php echo $this->pluginObjects['TemplatePluginFunctionCycle']->execute(array(), $this); ?> formElement">
												<p class="formFieldLabel"><?php $this->tagStack[] = array('lang', array()); ob_start(); ?>wcf.user.option.<?php echo StringUtil::encodeHTML($this->v['option']['optionName']); ?><?php $_langc1f386db57de5cdfb7ccf6c55fe832037ca08ac5 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langc1f386db57de5cdfb7ccf6c55fe832037ca08ac5, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></p>
...
?>
										<li class="floatedElement smallFont<?php if ($this->v['tpl']['foreach']['friends']['iteration'] == 5) { ?> last<?php } ?>">
											<a href="index.php?page=User&amp;userID=<?php echo $this->v['friend']->userID; ?><?php echo SID_ARG_2ND; ?>" title="<?php $this->tagStack[] = array('lang', array('username' => StringUtil::encodeHTML($this->v['friend']->username))); ob_start(); ?>wcf.user.viewProfile<?php $_lang820aed8188f1f32b292bbdede6412bbc2083da49 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang820aed8188f1f32b292bbdede6412bbc2083da49, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>">
...
?>
											<li class="<?php echo $this->pluginObjects['TemplatePluginFunctionCycle']->execute(array('values' => 'container-1,container-2'), $this); ?>">
												<div class="containerIcon">
													<a href="index.php?page=User&amp;userID=<?php echo $this->v['profileVisitor']->userID; ?><?php echo SID_ARG_2ND; ?>" title="<?php $this->tagStack[] = array('lang', array('username' => StringUtil::encodeHTML($this->v['profileVisitor']->username))); ob_start(); ?>wcf.user.viewProfile<?php $_langaf46f5c6805afc3b850dd26a24232ed0d401288b = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langaf46f5c6805afc3b850dd26a24232ed0d401288b, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>">
												...
												<div class="containerContent">
													<h4><a href="index.php?page=User&amp;userID=<?php echo $this->v['profileVisitor']->userID; ?><?php echo SID_ARG_2ND; ?>" title="<?php $this->tagStack[] = array('lang', array('username' => StringUtil::encodeHTML($this->v['profileVisitor']->username))); ob_start(); ?>wcf.user.viewProfile<?php $_lang4180984a21eec07c4975c65e8ab02a9c5c9d72ff = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang4180984a21eec07c4975c65e8ab02a9c5c9d72ff, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>"><?php echo StringUtil::encodeHTML($this->v['profileVisitor']->username); ?></a></h4>
...
<?php
$outerTemplateName9105dcbcb449f3a203fee4e1983231e4b251b7f8 = $this->v['tpl']['template'];
$this->includeTemplate('footer', array(), (false ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateName9105dcbcb449f3a203fee4e1983231e4b251b7f8;
