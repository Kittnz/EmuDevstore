...
<div id="footerContainer">
	<div id="footer">
		<?php
$outerTemplateNamec641cd459fa1a685303493bcb17188976f96f5c2 = $this->v['tpl']['template'];
$this->includeTemplate('footerMenu', array(), (1 ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateNamec641cd459fa1a685303493bcb17188976f96f5c2;
				...
				<ul>
					...
					<?php if (count($this->v['stylePickerOptions']) > 1) { ?>
						<li class="stylePicker<?php if ( ! SHOW_CLOCK) { ?> last<?php } ?>">
							<a id="changeStyle" class="hidden"><img src="<?php echo StyleManager::getStyle()->getIconPath('styleOptionsS.png'); ?>" alt="" /> <span>Cambia stile</span></a>
...
?>
								...
								<form method="get" action="index.php" class="quickJump">
									<div>
										...
										<select name="styleID" onchange="if (this.options[this.selectedIndex].value != 0) this.form.submit()">
											<option value="0">Cambia stile</option>
					...
					<?php } ?>
					<li id="toTopLink" class="last extraButton"><a href="#top" title="Vai all'inizio della pagina"><img src="<?php echo StyleManager::getStyle()->getIconPath('upS.png'); ?>" alt="Vai all'inizio della pagina" /> <span class="hidden">Vai all'inizio della pagina</span></a></li>
				</ul>
			</div>
		</div>
		<p class="copyright"><a href="http://www.woltlab.com">Forum Software: <strong>Burning Board&reg;<?php if (SHOW_VERSION_NUMBER) { ?> <?php echo PACKAGE_VERSION; ?><?php } ?></strong>, sviluppato da <strong>WoltLab&reg; GmbH</strong></a></p>
	</div>
</div>
	...
	<div class="border loginPopup hidden" id="quickLoginBox">
		<form method="post" action="index.php?form=UserLogin" class="container-1">
			<div>
				...
				<?php echo SID_INPUT_TAG; ?>
				<input tabindex="4" type="image" class="inputImage" src="<?php echo StyleManager::getStyle()->getIconPath('submitS.png'); ?>" alt="Invia" />
			</div>
			<p><label><input tabindex="3" type="checkbox" id="useCookies" name="useCookies" value="1" /> Resta connesso</label></p>
		</form>
	</div>
<?php } ?>