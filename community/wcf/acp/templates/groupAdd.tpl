...
<div class="contentHeader">
	<div class="largeButtons">
		<ul>
			<li><a href="index.php?page=GroupList&amp;packageID={@PACKAGE_ID}{@SID_ARG_2ND}" title="{lang}wcf.acp.menu.link.group.view{/lang}"><img src="{@RELATIVE_WCF_DIR}icon/groupM.png" alt="" /> <span>{lang}wcf.acp.menu.link.group.view{/lang}</span></a></li>
			{if $additionalLargeButtons|isset}{@$additionalLargeButtons}{/if}
		</ul>
	</div>
</div>
<form method="post" action="index.php?form=Group{@$action|ucfirst}">
			...
			<div class="tabMenu">
				<ul>
					{foreach from=$options item=categoryLevel1}
						<li id="{@$categoryLevel1.categoryName}"><a onclick="tabMenu.showSubTabMenu('{@$categoryLevel1.categoryName}');"><span>{lang}wcf.acp.group.option.category.{@$categoryLevel1.categoryName}{/lang}</span></a></li>
					{/foreach}
				</ul>
			</div>
