...
<!-- wbb styles -->
<link rel="stylesheet" type="text/css" media="screen" href="{@RELATIVE_WBB_DIR}style/burningBoard{if PAGE_DIRECTION == 'rtl'}-rtl{/if}.css" />
...
<script type="text/javascript">
	...
	var RELATIVE_WBB_DIR = '{@RELATIVE_WBB_DIR}';
...
<!--[if IE 8]>
	...
	{if $this->getStyle()->getVariable('user.MSIEFixes.IE8.use')}
	<style type="text/css">	
		{@$this->getStyle()->getVariable('user.MSIEFixes.IE8.use')}
	</style>
	{/if}
<![endif]-->
